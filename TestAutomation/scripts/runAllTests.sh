...
PATH_TO_KMP=$( cd .. ; cd .. ; pwd -P )

PATH_TO_ENKETO="$PATH_TO_KMP/testAutomation/project/enketo/enketo-express-2"

PATH_TO_TESTER_FILE_DIR="$PATH_TO_KMP/testAutomation/project/enketo/enketo-express-2/test/server/testCases"
...
then
  ...
  echo "KMP Path Location: $PATH_TO_KMP"
fi
